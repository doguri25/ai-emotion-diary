 ...
 */
const CITY_META = [
  { id: "jeju", name: "제주", km: 0, lon: 126.53, lat: 33.38, color: "#FFB703", fact: "한라산과 바다가 함께 있는 섬이에요.", food: "감귤", place: "한라산", stamp: "🍊", lx: 8, ly: 18 },
  { id: "busan", name: "부산", km: 40, lon: 129.08, lat: 35.18, color: "#4CC9F0", fact: "우리나라에서 가장 큰 바다 도시예요.", food: "밀면", place: "해운대", stamp: "🌊", lx: 12, ly: 4 },
  { id: "gyeongju", name: "경주", km: 80, lon: 129.22, lat: 35.86, color: "#F4A261", fact: "신라 천년의 이야기가 남아 있어요.", food: "황남빵", place: "불국사", stamp: "🏯", lx: 12, ly: -6 },
  { id: "ulsan", name: "울산", km: 110, lon: 129.31, lat: 35.54, color: "#90E0EF", fact: "고래와 태화강이 유명한 도시예요.", food: "울산 배", place: "대왕암", stamp: "🐋", lx: 12, ly: 4 },
  { id: "daegu", name: "대구", km: 150, lon: 128.60, lat: 35.87, color: "#E76F51", fact: "따뜻한 내륙 도시예요.", food: "사과", place: "83타워", stamp: "🍎", lx: -22, ly: -6 },
  { id: "gwangju", name: "광주", km: 210, lon: 126.85, lat: 35.16, color: "#9B5DE5", fact: "예향이라 불리는 빛고을이에요.", food: "떡갈비", place: "무등산", stamp: "🎨", lx: -22, ly: 4 },
  { id: "yeosu", name: "여수", km: 250, lon: 127.73, lat: 34.76, color: "#00BBF9", fact: "밤바다가 반짝이는 남쪽 항구예요.", food: "갓김치", place: "여수 밤바다", stamp: "🌃", lx: 10, ly: 14 },
  { id: "jeonju", name: "전주", km: 300, lon: 127.15, lat: 35.82, color: "#2A9D8F", fact: "한옥마을에서 비빔밥을 먹어요.", food: "비빔밥", place: "한옥마을", stamp: "🏘️", lx: -22, ly: -4 },
  { id: "daejeon", name: "대전", km: 350, lon: 127.38, lat: 36.35, color: "#577590", fact: "과학을 체험할 수 있는 도시예요.", food: "성심당 빵", place: "엑스포과학공원", stamp: "🔬", lx: -22, ly: 10 },
  { id: "sejong", name: "세종", km: 375, lon: 127.29, lat: 36.48, color: "#F94144", fact: "세종대왕의 이름을 딴 도시예요.", food: "복숭아", place: "세종호수공원", stamp: "📖", lx: -24, ly: -6 },
  { id: "cheongju", name: "청주", km: 410, lon: 127.49, lat: 36.64, color: "#43AA8B", fact: "세계에서 가장 오래된 금속활자가 나온 곳이에요.", food: "직지빵", place: "청남대", stamp: "🖨️", lx: 10, ly: -8 },
  { id: "chungju", name: "충주", km: 450, lon: 127.93, lat: 36.99, color: "#277DA1", fact: "호수가 아름다운 내륙 도시예요.", food: "사과", place: "충주호", stamp: "🏞️", lx: 10, ly: 12 },
  { id: "wonju", name: "원주", km: 495, lon: 127.95, lat: 37.34, color: "#F9844A", fact: "치악산과 한지가 유명해요.", food: "한과", place: "치악산", stamp: "📜", lx: 10, ly: 12 },
  { id: "gangneung", name: "강릉", km: 545, lon: 128.88, lat: 37.75, color: "#4D908E", fact: "경포대 바다와 커피가 유명해요.", food: "초당순두부", place: "경포대", stamp: "☕", lx: 12, ly: 4 },
  { id: "sokcho", name: "속초", km: 585, lon: 128.59, lat: 38.20, color: "#577590", fact: "설악산과 동해바다가 만나요.", food: "오징어순대", place: "설악산", stamp: "⛰️", lx: 12, ly: -8 },
  { id: "chuncheon", name: "춘천", km: 640, lon: 127.73, lat: 37.88, color: "#F72585", fact: "호수와 닭갈비의 도시예요.", food: "닭갈비", place: "남이섬", stamp: "🍗", lx: -8, ly: -12 },
  { id: "suwon", name: "수원", km: 700, lon: 127.00, lat: 37.26, color: "#B5179E", fact: "아름다운 화성 성곽이 있어요.", food: "갈비", place: "수원화성", stamp: "🧱", lx: 12, ly: 12 },
  { id: "incheon", name: "인천", km: 735, lon: 126.70, lat: 37.46, color: "#4895EF", fact: "비행기가 오가는 큰 항구 도시예요.", food: "짜장면", place: "월미도", stamp: "✈️", lx: -22, ly: 4 },
